...
[%%import: Migrate_500_414.attribute]
[@@deriving migrate
    ...
    ; default_dispatchers = [
      ...
      ; {
        srcmod = All_ast.Ast_5_0.Asttypes
      ; dstmod = DST.Asttypes
      ; types = [
          arg_label
        ; closed_flag
      ...
      ; {
        srcmod = All_ast.Ast_5_0.Parsetree
      ...
      ; {
          srcmod = All_ast.Ast_5_0.Outcometree
